...
module.exports = ResultCollectionView = (function(superClass) {
  ...
  ResultCollectionView.prototype.appendView = function(view) {
    return $('#result-view-as-table').dataTable().api().rows.add(view.$el).draw();
  };
...
buf.push("<div class=\"introduction\"><div class=\"page-header\"><h1>" + (jade.escape((jade_interp = t('welcome title')) == null ? '' : jade_interp)) + "</h1></div><p>" + (jade.escape((jade_interp = t('welcome message part1')) == null ? '' : jade_interp)) + "</p><p>" + (jade.escape((jade_interp = t('welcome message part2')) == null ? '' : jade_interp)) + "</p></div><div id=\"all-result\"><div class=\"btn-group result-buttons\"><button id=\"delete-all\" class=\"btn btn-xs\"><span></span><i class=\"icon-trash bigger-120\"></i></button></div><div id=\"basic-table\" class=\"table-responsive\"><table id=\"result-view-as-table\" class=\"table table-striped table-bordered table-hover\"><tbody></tbody></table></div><div class=\"load-more-result\"><span>" + (jade.escape((jade_interp = t('load more results')) == null ? '' : jade_interp)) + "&nbsp;</span><br/><i class=\"icon-circle-arrow-down\"></i></div></div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
