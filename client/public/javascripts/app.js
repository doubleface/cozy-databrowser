...
with (locals || {}) {
var interp;
buf.push('<div class="introduction"><div class="page-header"><h1>Welcome to your Cozy-Databrowser</h1></div><p>This application allows you to find any data in your cozy environement.</p><P>Please, explore the menu and select a type of document that you want to retrieve.</P></div><div id="all-result"><div id="basic-accordion" class="accordion-style1 panel-group"></div><div id="basic-table" class="table-responsive"><table id="result-view-as-table" class="table table-striped table-bordered table-hover"><tbody></tbody></table></div><div class="load-more-result"><span>' + escape((interp = t('load more results')) == null ? '' : interp) + '&nbsp;</span><br/><i class="icon-circle-arrow-down"></i></div></div>');
}
return buf.join("");
};
});
