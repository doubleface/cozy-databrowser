...
/***/ function(module, exports, __webpack_require__) {
	...
	function attrToString(attr) {
	    if (!(0, _underscore2.default)(attr).isObject()) return _underscore2.default.escape(attr);else {
	        var result = '<ul>';
	        for (var i in attr) {
	...
	exports.default = Backbone.View.extend({
	    ...
	    render: function render() {
	        ...
	        var config = {
	            ...
	            columns: columns,
	            columnDefs: [{
	                targets: columns.map(function (val, key) {
	                    return key;
	                }).filter(function (key) {
	                    return key !== columns.length - 1;
	                }), // no filter for the Action column
	                render: attrToString
	            }]
	        };
